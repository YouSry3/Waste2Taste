...
//   const [editingQuantity, setEditingQuantity] = useState<number>(listing.quantity ?? 0);
//   const [savingQuantity, setSavingQuantity] = useState(false);

//   const [editingExpiry, setEditingExpiry] = useState<string>(
//     listing.expiryDate ? listing.expiryDate.split("T")[0] : "",
//   );
...
//     try {
//       await listingApi.updateStock(listing.id, Number(editingQuantity));
...
//     try {
//       await listingApi.updateExpiry(listing.id, editingExpiry);
...
//         className="w-20 text-right rounded-md border px-2 py-1"
//         disabled={isLoading || savingQuantity}
//       />
//       <button
...
//         <div className="mb-4">
//           <label className="text-sm text-gray-500 block mb-1">Expiry</label>
...
//               disabled={isLoading || savingExpiry}
//             />
//             <button
//               className="text-sm text-blue-600 hover:underline"
//               onClick={saveExpiry}
