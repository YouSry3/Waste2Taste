...
//   // Vendor: update stock (PATCH /products/{id}/stock)
//   updateStock: async (id: string | number, quantity: number) => {
//     const payload = { quantity };
//     const res = await vendorApiClient.patch(`/products/${id}/stock`, null, {
//   params: { quantity },  // ← ?quantity=5
// });
//     return res.data;
//   },

//   // // Vendor: update expiry (PATCH /products/{id}/expire)
//   // updateExpiry: async (id: string | number, expiryDate: string) => {
//   //   const payload = { expiryDate };
//   //   const res = await vendorApiClient.patch(`/products/${id}/expire`, payload);
//   //   return res.data;
//   // },
