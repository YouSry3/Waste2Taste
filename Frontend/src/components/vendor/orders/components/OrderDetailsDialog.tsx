        ...
        <html>
          ...
          <body>
            ...
            <div class="section">
              ...
              <div class="label">Amount:</div>
              <div class="value" style="font-size: 24px; font-weight: bold;">${formatPrice(order.totalAmount)}</div>
            </div>
        ...
        <div className="mt-4 space-y-6">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-500">{order.paymentMethod || "Cash"}</p>
            </div>
          </div>
            ...
            <TabsContent value="details" className="space-y-4">
              ...
              <Card>
                <CardContent className="p-4">
                  <h4 className="font-semibold mb-3">Items Ordered</h4>
                  <div className="space-y-3">
                    {/* Single item display (API doesn't return itemsList array) */}
                    <div className="flex justify-between items-center py-2 border-b">
                      <div>
                        <p className="font-medium">{order.items || "Unknown Item"}</p>
                        <p className="text-sm text-gray-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card>
                  <CardContent className="p-4">
                    ...
                    <p className="font-medium">{order.vendorName || "Unknown"}</p>
                    <p className="text-sm text-gray-500 mt-1">
                      {order.vendorPhone || "No phone"}
                    </p>
                  </CardContent>
                </Card>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            ...
            {(order.status === "In Progress" || order.status === "Pending Pickup" || order.status === "Pending") && (
              <Button
