...
interface VendorModerationProps {
  ...
  selectedVendors: ModerationId[];
  loadingStates: { [key: string]: boolean };
  statusFilter: string;
  totalVendorsPages: number;
  vendorsPage: number;
  onSelectVendor: (id: ModerationId, checked: boolean) => void;
  onApproveVendor: (id: ModerationId) => void;
  onRejectVendor: (id: ModerationId) => void;
  onBulkApproveVendors: (selectedVendors: ModerationId[]) => Promise<ModerationId[]>;
  onBulkRejectVendors: (selectedVendors: ModerationId[]) => Promise<ModerationId[]>;
