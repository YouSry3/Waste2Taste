      ...
      <CardContent className="p-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {/* Destructive Action - Reject All Vendors */}
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>
                    Reject {selectedCount} vendor applications?
                  </AlertDialogTitle>
                  <AlertDialogDescription>
                    This will reject all selected vendor applications.
                    Applicants will be notified. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
